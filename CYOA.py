...
def InvestigateE():
    ...
    if storage == "banana":
        ...
        game["chairFront"] = True
    elif storage == "giant expo marker":
    ...
    elif storage == "horn polishing solution":
...
#They tried to sneak towards the door
    if sceneOne == 1:
        if game["chairFront"]:
            ...
            if a1 == 1:
                ...
                tw("You reach into your backpack without looking\nYou grab a...\n")
                DefensiveE()
    elif sceneOne == 2:
