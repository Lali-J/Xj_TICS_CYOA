...
inventoryD = ["HDMI cable", "Horn polishing solution", "Fried chicken receipt", "Backup Horn"]
...
def InvestigateE():
    ...
    if storage == "Bannana" or storage == "bannana":
    ...
    elif storage == "Horn Polishing Solution" or storage == "horn polishing solution":
        ...
        tw("You show him" ,storage, "\nHe looks at you with so much excitement\n\"I have a very important question for you so answer carefully\"\n")
        FriedChickenE()
